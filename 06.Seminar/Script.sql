...
DROP PROCEDURE IF EXISTS lesson_4.sp_friendship_offers;

DELIMITER $$
$$
CREATE PROCEDURE lesson_4.sp_friendship_offers(for_user_id BIGINT)
BEGIN
-- друзья
WITH friends AS (
...
DROP FUNCTION IF EXISTS lesson_4.friendship_direction;
DELIMITER $$
$$
CREATE FUNCTION lesson_4.friendship_direction(check_user_id BIGINT)
